...
public class WebDriverWaits extends BrowsersInvoked {
	...
	static WebDriverWait wait20 = new WebDriverWait(getDriver(), 20);
	static WebDriverWait wait5mins = new WebDriverWait(getDriver(), 120);
	...
	public static void SendKeys(By element, String value) {
		...
		WebElement ele = driver.findElement(element);
		ele.sendKeys(value);
		Log.info("Entering data for "+ele+" ------"+value);
	}
