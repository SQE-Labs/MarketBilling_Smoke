...
public class Customer extends BasePage {
    ...
    public static By detailsIcon = By.className("icon-reorder");
  ...
  public  static  By groupTag =By.xpath("(//label[@class=\"col-sm-12 control-label\"]/b)[1]");
    public static By settingsTab = By.xpath("//a[text()=' Settings']");
    public  static  By recentCustomerId =By.xpath("(//td[@class=\"sorting_1\"]/a)[1]");
    ...
    public static String getGroupName(){
        String groupName=WebDriverWaits.GetText(groupTag);
        System.out.println("GroupName of customer is "+ groupName);
      return  groupName ;


    }
    public static String clickRecentCustomerId(){
        String customerId=WebDriverWaits.GetText(recentCustomerId);
        WebDriverWaits.ClickOn(recentCustomerId);
     return customerId;
    ...
    public static String searchRecentCustomer() throws InterruptedException {
        getDriver().get(DataInterface.AdminURL);
